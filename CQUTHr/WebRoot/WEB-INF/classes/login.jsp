...
<html>
  <head>
	...
	-->
	  <script type="text/javascript" src="js/http_cdn.bootcss.com_jquery_3.3.1_jquery.js"></script>
	  <style>
		  html{
			  height:100%;
			  width: 100%;
  ...
  <body>
  <div class="top_div">
	  <h1 style="margin:auto;padding: 30px 200px 10px 0px;text-align: center;color: #fff">??????</h1>
	  <div style="width: 400px;height: 300px;margin: auto auto;padding: 0px 200px 10px 0px;background: #fff;text-align: center;margin-top: 100px;border: 1px solid #cecece">
		  ...
		  <p style="padding: 60px 0px 10px 0px;position: relative;">
			  ...
			  <input class="ipt" type="text" placeholder="??????">
		  </p>
		  <p style="padding: 20px 0px 10px 0px;position: relative;">
			  <span class="p_logo"></span>
			  <input id="password" class="ipt" type="password"  placeholder="?????">
		  </p>

		  <div>
			  <p style="margin: 40px 35px 80px 45px;">
                <span style="padding:20px -22px 10px 20px">
                    <a href="#" style="background: #12a3ef;padding: 10px 145px;border-radius: 4px;color: #FFF;font-weight: bold;">??</a>
                </span>
			  </p>
		  </div>
	  </div>
